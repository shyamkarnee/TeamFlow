                        ...
                        >
                          ...
                          {(isAssignedToMe || isManagerOrAdmin) && (
                            <div className="mt-3 pt-3 border-t border-slate-100 flex flex-wrap gap-1.5">
                              ...
                              {/* REVIEW COLUMN -> APPROVE / REJECT (Only Manager / Admin) */}
                              {task.status === "Review" && (
                                <div className="w-full space-y-2">
                                  {isManagerOrAdmin ? (
                                    <>
                                      {rejectionTaskId === task.id ? (
                                        <div className="bg-slate-50 p-2 border border-slate-100 rounded-lg space-y-2">
                                          <textarea
                                        ...
                                        <div className="flex gap-1.5 w-full">
                                          <button
                                            ...
                                            className="flex-1 py-1 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-lg text-[10px] flex items-center justify-center gap-1 cursor-pointer"
                                          >
                                          ...
                                          <button
                                            onClick={() => handleStatusTransition(task, "In Progress")}
                                            className="flex-1 py-1 bg-rose-600 hover:bg-rose-500 text-white font-semibold rounded-lg text-[10px] flex items-center justify-center gap-1 cursor-pointer"
                                          >
                                            <X className="w-3 h-3" />
                                            Reject
                                          </button>
                                    ...
                                    <div className="text-[10px] text-slate-400 text-center italic py-1 border border-dashed border-slate-200 rounded-lg">
                              ...
                              {/* COMPLETED COLUMN -> ALLOW REOPEN (Only Manager) */}
